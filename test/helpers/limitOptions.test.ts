import { limitOptions, improvdedLimitOptions } from "../../src/helpers/limitOptions";
...
describe('improved', () => {
  it('should return limted options', () => {
    ...
    const result  = improvdedLimitOptions(options, no_of_passengers)
    // expect(result.length).toEqual(1);
    expect(result).toEqual([{"car_type": "PEOPLE_CARRIER","price": 4}])
  })
})
